...
const balloonColors = ['#FF6B6B', '#4ECDC4', '#45B7D1', '#FFA07A', '#800020']
...
export default function BirthdayWish() {
  ...
  const celebrate = () => {
   ...
   return (
    // Main container
    <div className="min-h-screen bg-gradient-to-r from-violet-900 via-blue-500 to-purple-900 flex items-center justify-center p-4">
      ...
      >
        <Card className="bg-teal-100 mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl hover:scale-105 border-2 border-black">
          ...
          <CardHeader className="text-center">
            <CardTitle className="text-4xl text-gray-700 font-serif font-bold">Happy Belated Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold font-serif italic text-teal-600">Asharib Ali</CardDescription>
            <p className="text-lg font-serif italic text-yellow-900">May your year ahead be filled with all the happiness and success you deserve</p>
          </CardHeader>
